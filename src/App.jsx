...
export default () => (
    ...
    <div className="App">
        ...
        <div className="Cards">
            <Card titulo="#13 - Mega Sena" color="#E30A07"> 
               <Mega qtde={8}/>
            </Card>

            <Card titulo="#12 - Contador" color="#EBC447"> 
                <Contador numeroInicial={10}/>

            </Card>
            <Card titulo="#11 - Componente Controlado" color="#C4A9F5"> 
                <Input />
            </Card>

            <Card titulo="#10 - Comunicação Indireta" color="#4327F2"> 
                <IndiretaPai />
            </Card>
